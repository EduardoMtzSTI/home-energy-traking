package com.marman.usage_service.service;
...
import com.marman.usage_service.client.DeviceClient;
import com.marman.usage_service.client.UserClient;
import com.marman.usage_service.dto.DeviceDto;
import com.marman.usage_service.dto.UsageDto;
import com.marman.usage_service.dto.UserDto;
import com.marman.usage_service.model.Device;
import com.marman.usage_service.model.DeviceEnergy;
...
public class UsageService {
    ...
    public UsageDto getXDaysUsageForUser(Long userId, int days) {
        ...
        log.info("deviceFilter: {}",deviceFilter);
        ...
        for (Device device : devices) {
            ...
            Double energyConsumed = aggregatedMap.getOrDefault(device.getId(), 0.0);
